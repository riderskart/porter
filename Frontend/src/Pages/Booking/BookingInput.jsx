  ...
  return (
    <div className=" w-full phone:h-fit">
      ...
      <div className="laptop:h-80 relative w-full z-50 ">
        <div className=" phone:max-w-[90vw] laptop:max-w-[80vw] laptop:absolute bottom-20 laptop:mx-40 phone:mx-auto phone:my-auto p-6 backdrop-blur-2xl rounded-lg shadow-lg phone:h-fit phone:top-4 phone:mb-10 laptop:-top-40 phone:w-full">
