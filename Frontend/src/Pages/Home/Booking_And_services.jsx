...
const Booking_And_services = () => {
  ...
  const OurServicesCard = ({ field }) => {
    return (
      <div className="relative h-52 w-96 rounded-xl backdrop-blur-md backdrop-brightness-95 text-black mb-10 drop-shadow-xl overflow-hidden shadow flex justify-around items-start flex-col">
        ...
        <div className="Description text-xl px-5 font-Fredoka heading-text-gray">
          {field.description}
        </div>
        <div className="px-5 ">
